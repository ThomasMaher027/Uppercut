...
def communication(angleA = -900, angleB = -900, angleC = -900, angleD = -900, pos_main = -900):
...
def main():
    ...
    message = RepeatedTimer(0.5, communication(), angleA, angleB, angleC, angleD, pos_main)
